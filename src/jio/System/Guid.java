...
public class Guid extends ValueType implements IFormattable, IComparable {
  ...
  public Guid(java.lang.Byte[] b) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Guid", new Object[] {b});
  ...
  public Guid(
    ...
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Guid", a, b, c, d, e, f, g, h, i, j, k);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public Guid(java.lang.Integer a, java.lang.Short b, java.lang.Short c, java.lang.Byte[] d) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Guid", a, b, c, new Object[] {d});
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  ...
  public Guid(java.lang.String g) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Guid", g);
      super.setJavonetHandle(javonetHandle);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
